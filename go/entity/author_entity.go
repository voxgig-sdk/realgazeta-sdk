...
func NewAuthorEntity(client *core.RealgazetaSDK, entopts map[string]any) *AuthorEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AuthorEntity) GetName() string { return e.name }
...
func (e *AuthorEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AuthorEntity) Deleted() bool {
	return e.deleted
}


func (e *AuthorEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAuthorEntity(e.client, opts)
}

func (e *AuthorEntity) Data(args ...any) any {
...
func (e *AuthorEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *AuthorEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AuthorEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *AuthorEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *AuthorEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *AuthorEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AuthorEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility

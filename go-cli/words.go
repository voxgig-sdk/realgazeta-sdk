...
func registerSDKWords(r *eng.Registry, client *sdk.RealgazetaSDK) {
...
func runOp(client *sdk.RealgazetaSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {

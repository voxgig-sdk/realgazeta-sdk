...
module RealgazetaTestRunner
  ...
  def self.env_override(m)
    live = getenv("REALGAZETA_TEST_LIVE")
    override = getenv("REALGAZETA_TEST_OVERRIDE")
    ...
    explain = getenv("REALGAZETA_TEST_EXPLAIN")
    m["REALGAZETA_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = RealgazetaTestRunner
Helpers = RealgazetaHelpers
Vs = VoxgigStruct

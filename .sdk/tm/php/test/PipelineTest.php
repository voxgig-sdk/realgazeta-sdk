...
{
    private static function utility(): RealgazetaUtility
    {
        return new RealgazetaUtility();
    }
    ...
    private static function ctx(array $over = []): RealgazetaContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new RealgazetaContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new RealgazetaOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof RealgazetaError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new RealgazetaOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = RealgazetaMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new RealgazetaOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = RealgazetaMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new RealgazetaOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = RealgazetaMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new RealgazetaSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = RealgazetaMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new RealgazetaResponse([]),
            'result' => new RealgazetaResult([]),
        ]);
        [, $err] = RealgazetaMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new RealgazetaSpec([]),
            'response' => null,
            'result' => new RealgazetaResult([]),
        ]);
        [, $err] = RealgazetaMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new RealgazetaSpec(['step' => 's']),
            'response' => new RealgazetaResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new RealgazetaResult([]),
        ]);
        [, $err] = RealgazetaMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new RealgazetaSpec(['step' => 's']),
            'response' => new RealgazetaResponse(self::resp(200, ['v' => 1])),
            'result' => new RealgazetaResult([]),
        ]);
        [, $err] = RealgazetaMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new RealgazetaSpec(['step' => 's']),
            'response' => new RealgazetaResponse(self::resp(200, ['v' => 2])),
            'result' => new RealgazetaResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        RealgazetaMakeResponse::call($ctx);
    ...
    {
        $preset = new RealgazetaResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new RealgazetaSpec([]),
            'response' => new RealgazetaResponse([]),
            'result' => new RealgazetaResult([]),
        ...
        [$got, $err] = RealgazetaMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new RealgazetaResult([])]);
        [, $err] = RealgazetaMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new RealgazetaSpec([]), 'result' => null]);
        [, $err] = RealgazetaMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new RealgazetaSpec(['step' => 's']),
            'result' => new RealgazetaResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new RealgazetaOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = RealgazetaMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new RealgazetaSpec(['step' => 's']),
            'result' => new RealgazetaResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new RealgazetaOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = RealgazetaMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new RealgazetaResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new RealgazetaSpec([]),
            'result' => new RealgazetaResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = RealgazetaMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = RealgazetaMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new RealgazetaError('boom', 'boom');
        $utility->fetcher = function (RealgazetaContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new RealgazetaSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = RealgazetaMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (RealgazetaContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = RealgazetaMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(RealgazetaResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        RealgazetaMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (RealgazetaContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new RealgazetaSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = RealgazetaMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new RealgazetaResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new RealgazetaSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = RealgazetaMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = RealgazetaMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = RealgazetaMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new RealgazetaResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, RealgazetaDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new RealgazetaResult(['ok' => false])]);
        $this->expectException(RealgazetaError::class);
        RealgazetaDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new RealgazetaResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', RealgazetaMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        RealgazetaMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new RealgazetaBaseFeature();
        $b = new RealgazetaBaseFeature();
        RealgazetaFeatureAdd::call($ctx, $a);
        RealgazetaFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): RealgazetaBaseFeature
    {
        $f = new RealgazetaBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        RealgazetaFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): RealgazetaContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new RealgazetaSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = RealgazetaPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        RealgazetaPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new RealgazetaResponse(['headers' => null]),
            'result' => new RealgazetaResult([]),
        ]);
        RealgazetaResultHeaders::call($ctx);

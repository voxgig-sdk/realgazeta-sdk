...
// Realgazeta SDK timeout feature
...
class RealgazetaTimeoutFeature extends RealgazetaBaseFeature
{
    ...
    private function _with_timeout(RealgazetaContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(RealgazetaContext $_ctx, float $ms): void
    {
        $client = $this->client;

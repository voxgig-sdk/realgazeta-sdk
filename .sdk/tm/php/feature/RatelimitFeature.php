...
// Realgazeta SDK ratelimit feature
...
class RealgazetaRatelimitFeature extends RealgazetaBaseFeature
{
    ...
    private function _acquire(RealgazetaContext $ctx): void
    {
    ...
    private function _track(RealgazetaContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;

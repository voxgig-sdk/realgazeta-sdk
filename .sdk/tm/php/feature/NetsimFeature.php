...
class RealgazetaNetsimFeature extends RealgazetaBaseFeature
{
    ...
    private function _simulate(RealgazetaContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(RealgazetaContext $ctx, array $applied): void
    {
        $client = $this->client;

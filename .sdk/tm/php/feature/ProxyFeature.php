...
class RealgazetaProxyFeature extends RealgazetaBaseFeature
{
    ...
    public function init(RealgazetaContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (RealgazetaContext $ctx2, string $url2, array $fetchdef) use ($inner): array {

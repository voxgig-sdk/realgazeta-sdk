...
class RealgazetaRbacFeature extends RealgazetaBaseFeature
{
    ...
    private function _required(RealgazetaContext $ctx): ?string
    {
    ...
    private function _reject(RealgazetaContext $ctx, string $required): void
    {
    ...
    private function _track(RealgazetaContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;

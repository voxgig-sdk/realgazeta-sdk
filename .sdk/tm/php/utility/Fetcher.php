...
// Realgazeta SDK utility: fetcher

class RealgazetaFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; RealgazetaSDK/1.0)';
    ...
    public static function call(RealgazetaContext $ctx, string $fullurl, array $fetchdef): array
    {

...
// Realgazeta SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class RealgazetaMakeRequest
{
    public static function call(RealgazetaContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new RealgazetaResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new RealgazetaResponse($fetched);
        } else {

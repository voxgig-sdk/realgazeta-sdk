...
describe("AuthorDirect", function()
  it("should direct-load-author", function()
    local setup = author_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-author", setup.live and "live" or "unit")

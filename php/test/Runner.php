...
class RealgazetaTestRunner
{
    ...
    {
        $live = self::getenv('REALGAZETA_TEST_LIVE');
        $override = self::getenv('REALGAZETA_TEST_OVERRIDE');
        ...
        $explain = self::getenv('REALGAZETA_TEST_EXPLAIN');
...
class_alias('RealgazetaTestRunner', 'Runner');
class_alias('RealgazetaHelpers', 'Helpers');

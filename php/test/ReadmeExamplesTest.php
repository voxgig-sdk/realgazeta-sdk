...
// Realgazeta SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (RealgazetaSDK::test)
...
{
    private const SDK_CLASS = 'RealgazetaSDK';
    ...
    private const SDK_BASE = 'realgazeta_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../realgazeta_sdk.php';
        foreach ($this->phpBlocks() as $blk) {

...
// Realgazeta SDK utility: graphql
//
...
class RealgazetaGraphql
{
    ...
    // equivalent.
    public static function body(RealgazetaContext $ctx): mixed
    {
    ...
    public static function errors(RealgazetaContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;

...
// Realgazeta SDK utility: param

require_once __DIR__ . '/../core/Helpers.php';

class RealgazetaParam
{
    public static function call(RealgazetaContext $ctx, mixed $paramdef): mixed
    {
        $point = $ctx->point;
        $spec = $ctx->spec;
        $match_val = $ctx->match;
        ...
        $akey = '';
        if ($point) {
            $alias_map = RealgazetaHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'alias'));
            if ($alias_map) {

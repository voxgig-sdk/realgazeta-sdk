...
// Realgazeta SDK clienttrack feature
...
class RealgazetaClienttrackFeature extends RealgazetaBaseFeature
{
    ...
    public function PostConstruct(RealgazetaContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Realgazeta-SDK';

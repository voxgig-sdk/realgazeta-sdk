...
class RealgazetaCacheFeature extends RealgazetaBaseFeature
{
    ...
    private function _through(RealgazetaContext $ctx, string $url, array $fetchdef, callable $inner): array
    {

...
// Realgazeta SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class RealgazetaTestFeature extends RealgazetaBaseFeature
{
    ...
    public function init(RealgazetaContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (RealgazetaContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = RealgazetaParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (RealgazetaContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(RealgazetaContext $ctx, $op, $args): array
    {

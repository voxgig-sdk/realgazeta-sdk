...
// Realgazeta SDK streaming feature
...
class RealgazetaStreamingFeature extends RealgazetaBaseFeature
{
    ...
    private function _iterate(RealgazetaResult $result): \Generator
    {
    ...
    private function _streamable(RealgazetaContext $ctx): bool
    {

...
type Args struct {
	Entity string         `json:"entity" jsonschema:"author"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.RealgazetaSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "realgazeta_list",
		Description: "List records from Realgazeta. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "realgazeta_load",
		Description: "Load a single record from Realgazeta. " +
...
func runOp(client *sdk.RealgazetaSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.RealgazetaSDK, name string) (sdk.RealgazetaEntity, error) {
	switch strings.ToLower(name) {
	case "author":
		return client.Author(nil), nil

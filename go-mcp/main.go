// Command Realgazeta-mcp is an MCP server exposing the Realgazeta
// SDK as MCP tools.
//
// Two tools are registered:
//
//	Realgazeta_list  — list records of an entity
//	Realgazeta_load  — load a single record of an entity
//

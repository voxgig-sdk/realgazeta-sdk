...
from realgazeta_sdk.utility import register

# Load features
from realgazeta_sdk.feature.base_feature import RealgazetaBaseFeature
from realgazeta_sdk.features import _make_feature
...
class RealgazetaSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = RealgazetaUtility()
        self._utility = utility

        from realgazeta_sdk.config import make_config
        config = make_config()
    ...
    def get_utility(self):
        return RealgazetaUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("RealgazetaSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Author(self, data=None) -> "AuthorEntity":
        ...
        from realgazeta_sdk.entity.author_entity import AuthorEntity
        return AuthorEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "RealgazetaSDK":
        if sdkopts is None:
            sdkopts = {}

...
from realgazeta_sdk.core.control import RealgazetaControl
...
from realgazeta_sdk.core.helpers import get_ctx_prop, to_map
...
class RealgazetaContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, RealgazetaSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, RealgazetaResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, RealgazetaResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return RealgazetaError(code, msg, self)

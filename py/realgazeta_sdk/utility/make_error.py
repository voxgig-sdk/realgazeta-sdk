# Realgazeta SDK utility: make_error
...
def make_error_util(ctx, err):
    ...
    errmsg = ""
    if isinstance(err, RealgazetaError):
        errmsg = err.msg
    ...
    msg = "RealgazetaSDK: " + opname + ": " + errmsg
    ...
    sdk_err = RealgazetaError("", msg, ctx)

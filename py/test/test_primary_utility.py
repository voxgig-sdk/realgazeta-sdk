...
from realgazeta_sdk.core.spec import RealgazetaSpec
from realgazeta_sdk.core.result import RealgazetaResult
from realgazeta_sdk.core.response import RealgazetaResponse
from realgazeta_sdk.core.operation import RealgazetaOperation
from realgazeta_sdk.core.error import RealgazetaError
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return RealgazetaError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = RealgazetaSDK.test(None, None)
    ...
    def test_feature_init_basic(self):
        init_client = RealgazetaSDK.test(None, None)
        ...
        class TestInitFeature(RealgazetaBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(RealgazetaBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = RealgazetaSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = RealgazetaSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = RealgazetaSDK.test(None, setup_opts)

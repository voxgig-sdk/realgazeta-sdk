# Realgazeta SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions RealgazetaSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both RealgazetaSDK(...) and RealgazetaSDK.test(...) become
#      RealgazetaSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "realgazeta_sdk"
_SDK_CLASS = "RealgazetaSDK"

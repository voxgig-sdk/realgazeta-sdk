# Realgazeta Python SDK



The Python SDK for the Realgazeta API — an entity-oriented client following Pythonic conventions.
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/realgazeta-sdk/releases)) or
...
```
py/
├── realgazeta_sdk.py         -- Main SDK module
